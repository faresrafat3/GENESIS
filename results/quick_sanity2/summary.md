...
|---|-------|-------|-----------|-----|---------|---------|-----------|------|-----|
| 1 | `nemotron-3-nano-free` | **66.67** | - | - | 2/3 | 1 | 0 | 76s | 0.04 |
...
- **faresrafatfares**: 0 requests, 0 ok, 0 failed (0.0% success) — available
- **faresrafat434**: 1 requests, 1 ok, 0 failed (100.0% success) — available
- **faresrafat435**: 1 requests, 1 ok, 0 failed (100.0% success) — available
- **faresrafat436**: 1 requests, 1 ok, 0 failed (100.0% success) — available
- **faresrafat437**: 1 requests, 1 ok, 0 failed (100.0% success) — available
